...
import { CheckCircle2, XCircle, Trash2, Loader } from 'lucide-react';
    ...
    <div className={`flex ${isModal ? 'justify-end mt-4' : 'space-x-2'}`}>
      {currentStatus !== 'approved' && (
        <button
          ...
          disabled={loading}
          className="py-2 px-4 bg-emerald-600 text-white rounded-xl text-sm hover:bg-emerald-700 disabled:bg-gray-400 flex items-center gap-2 transition-all duration-200 shadow-md"
      ...
      {currentStatus !== 'not_approved' && (
        <button
          ...
          disabled={loading}
          className="py-2 px-4 bg-red-600 text-white rounded-xl text-sm hover:bg-red-700 disabled:bg-gray-400 flex items-center gap-2 transition-all duration-200 shadow-md"
      ...
      <button
        ...
        disabled={loading}
        className="py-2 px-4 bg-blue-600 text-white rounded-xl text-sm hover:bg-blue-700 disabled:bg-gray-400 flex items-center gap-2 transition-all duration-200 shadow-md"
