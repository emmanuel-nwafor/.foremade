  ...
  <div className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50 py-10">
    <div className="max-w-3xl mx-auto">
      ...
      <div className="flex flex-col items-center text-center mb-8">
        <img src={HeroImage} alt="Refund Policy" className="w-40 h-40 mb-4" />
        <h1 className="text-3xl md:text-4xl font-extrabold text-blue-700 mb-2">Refund Policy</h1>
        <p className="text-gray-600 max-w-xl">Understand how Foremade handles refunds and protects your purchases.</p>
      </div>
      {/* Policy Card */}
