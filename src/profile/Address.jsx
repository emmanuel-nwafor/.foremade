        ...
        <div className="md:w-3/4">
          ...
          <div className="rounded-lg p-6 mb-6 bg-gray-50">
            ...
            <form onSubmit={handleAddOrUpdateAddress} className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-slate-400">Street</label>
                <input
                  type="text"
                  name="street"
              ...
              <div>
                <label className="block text-slate-400">State</label>
                <input
                  type="text"
                  name="state"
              ...
              <div>
                <label className="block text-slate-400">Country</label>
                <input
                  type="text"
                  name="country"
              ...
              <div>
                <label className="block text-slate-400">Postal Code</label>
                <input
                  type="text"
                  name="postalCode"
            ...
            {addresses.length === 0 ? (
              ...
              <div className="space-y-4">
                {addresses.map((address) => (
                  <div key={address.id} className="flex justify-between items-center p-4 bg-gray-100 rounded-lg">
                    <div>
