...
export default function Profile() {
  ...
  if (!userData) {
    return (
      <div className="container mx-auto px-4 py-8 text-center">
        <p className="text-red-600 dark:text-red-400">User data not available.</p>
        <button
          onClick={() => {
            setError('');
            setLoading(true);
      ...
      <div className="flex flex-col md:flex-row gap-4">
        ...
        <div className="md:w-3/4">
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-6">
            <Link to="/orders" className="rounded-lg p-4 text-center bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 transition">
            ...
            <div className="rounded-lg p-4 text-center bg-gray-50 dark:bg-gray-800">
