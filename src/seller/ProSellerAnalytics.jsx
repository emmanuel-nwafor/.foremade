...
const ProSellerAnalytics = () => {
  ...
  if (userProfile && !userProfile.isProSeller) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
        <div className="bg-white p-4 sm:p-6 rounded-lg shadow text-center max-w-xs sm:max-w-md mx-auto">
          <h2 className="text-xl sm:text-2xl font-bold mb-4 text-orange-600">Pro Seller Feature</h2>
          <p className="mb-4 text-gray-700 text-sm sm:text-base">Product analytics are only available to Pro Sellers. Upgrade now to track your performance and sales metrics!</p>
          <a href="/pro-seller-guide-full" className="inline-block px-4 py-2 sm:px-6 sm:py-2 bg-orange-500 text-white rounded hover:bg-orange-600 font-semibold text-sm sm:text-base">Upgrade to Pro Seller</a>
          <div className="mt-4 sm:mt-6">
            <a href="/sell" className="inline-block px-4 py-2 sm:px-5 sm:py-2 bg-gray-200 text-gray-800 rounded hover:bg-gray-300 font-semibold text-sm sm:text-base">Return to Dashboard</a>
          </div>
        </div>
      </div>
    );
        ...
        <div className="flex-1 ml-0 md:ml-64 p-2 sm:p-4 flex justify-center items-center">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 w-full max-w-4xl">
            {Array.from({ length: 6 }).map((_, i) => (
              <div key={i} className="bg-white border border-gray-200 rounded-xl p-2 sm:p-3 shadow-md animate-pulse h-48 sm:h-56" />
            ))}
          </div>
        </div>
      </div>
    ...
    return (
      <div className="min-h-screen flex bg-gradient-to-br from-gray-100 to-gray-50">
        ...
        <div className="bg-white p-4 sm:p-6 rounded-lg shadow text-center max-w-xs sm:max-w-md mx-auto">
          ...
          <p className="mb-4 text-gray-700 text-sm sm:text-base">{error}</p>
          <a href="/sell" className="inline-block px-4 py-2 sm:px-5 sm:py-2 bg-gray-200 text-gray-800 rounded hover:bg-gray-300 font-semibold text-sm sm:text-base">Return to Dashboard</a>
        </div>
      </div>
    );
  ...
  return (
    <div className="min-h-screen flex bg-gray-50">
      <SellerSidebar />
      <div className="flex-1 ml-0 md:ml-64 p-2 sm:p-4">
        <div className="mb-4 sm:mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 sm:gap-4">
          <Link to="/sell" className="inline-block px-3 sm:px-4 py-1 sm:py-2 bg-gray-200 text-gray-800 rounded hover:bg-gray-300 font-semibold text-xs sm:text-sm">
            Return to Dashboard
          </Link>
        </div>
        ...
        <div className="mb-4 sm:mb-6">
          <h1 className="text-xl sm:text-3xl font-bold text-gray-900">Pro Seller Analytics</h1>
          <p className="text-gray-600 mt-1 sm:mt-2 text-xs sm:text-base">Track your performance and sales metrics</p>
        ...
        {(!analytics.topProducts?.length && !analytics.monthlyTrends?.length) && (
          <div className="text-center text-gray-500 mb-4 sm:mb-6 text-xs sm:text-base">No analytics data available yet.</div>
        )}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-4 mb-4 sm:mb-6">
          <div style={cardStyle} className="flex items-center">
            ...
            <div className="ml-2 sm:ml-4">
              ...
              <p className="text-base sm:text-2xl font-bold text-gray-900">{formatNumber(analytics.totalProducts)}</p>
            </div>
          </div>
          ...
          <div style={cardStyle} className="flex items-center">
            ...
            <div className="ml-2 sm:ml-4">
              ...
              <p className="text-base sm:text-2xl font-bold text-gray-900">{formatNumber(analytics.totalViews)}</p>
            </div>
          </div>
          ...
          <div style={cardStyle} className="flex items-center">
            ...
            <div className="ml-2 sm:ml-4">
              ...
              <p className="text-base sm:text-2xl font-bold text-gray-900">{formatCurrency(analytics.totalSales)}</p>
            </div>
          </div>
          ...
          <div style={cardStyle} className="flex items-center">
            ...
            <div className="ml-2 sm:ml-4">
              ...
              <p className="text-base sm:text-2xl font-bold text-gray-900">{analytics.averageRating.toFixed(1)}</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-2 sm:gap-4 mb-4 sm:mb-6">
          <div style={cardStyle}>
            <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2 sm:mb-4">Monthly Trends</h3>
            <div className="w-full h-40 sm:h-64 md:h-80">
              <Line data={lineData} options={chartOptions} />
            </div>
          </div>

          <div style={cardStyle}>
            <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2 sm:mb-4">Top Products</h3>
            <div className="w-full h-40 sm:h-64 md:h-80">
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
                  <th className="px-2 sm:px-4 py-1 sm:py-2 text-left text-xs sm:text-sm font-medium text-gray-500 uppercase tracking-wider">Product</th>
                  <th className="px-2 sm:px-4 py-1 sm:py-2 text-left text-xs sm:text-sm font-medium text-gray-500 uppercase tracking-wider">Views</th>
                  <th className="px-2 sm:px-4 py-1 sm:py-2 text-left text-xs sm:text-sm font-medium text-gray-500 uppercase tracking-wider">Sales</th>
                  <th className="px-2 sm:px-4 py-1 sm:py-2 text-left text-xs sm:text-sm font-medium text-gray-500 uppercase tracking-wider">Revenue</th>
                </tr>
              </thead>
              <tbody className="bg-white divide-y divide-gray-200">
                {analytics.topProducts.map((product, index) => (
                  <tr key={product.productId}>
                    <td className="px-2 sm:px-4 py-1 sm:py-2 whitespace-nowrap text-sm sm:text-base font-medium text-gray-900">
                      {product.name}
                    </td>
                    <td className="px-2 sm:px-4 py-1 sm:py-2 whitespace-nowrap text-sm sm:text-base text-gray-900">
